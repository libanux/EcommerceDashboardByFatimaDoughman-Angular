...
export class DashboardComponent implements OnInit {
  ...
  constructor(private darkModeService: DarkmodeService) {
    ...
    this.ELEMENT_DATA = [
      ...
      { position: 2, Customername: 'Helium', city: "us", orderdate: new Date(), status: 'Inactive', account: 'Acc2', IDcustomer: '#8373' },
      { position: 3, Customername: 'Lithium', city: "italy", orderdate: new Date(), status: 'Active', account: 'Acc3', IDcustomer: '#5433' },
      { position: 4, Customername: 'Beryllium', city: "lebanon", orderdate: new Date(), status: 'Inactive', account: 'Acc4', IDcustomer: '#2231' },
      { position: 5, Customername: 'Boron', city: "beirut", orderdate: new Date(), status: 'Active', account: 'Acc5', IDcustomer: '#5951' },
      { position: 6, Customername: 'Carbon', city: "nabatieh", orderdate: new Date(), status: 'Inactive', account: 'Acc6', IDcustomer: '#7841' },
    ];
    ...
    this.options3 = {
      data: this.getData3(),
      series: [{
        title: { text: 'Sales by Category', color: '#333333' },
        type: 'pie',
  ...
  updateChartTheme(): void {
    const chartBackground: AgChartBackground = {
      fill: this.isDarkMode ? '#232323' : '#ffffff',
      visible: true,
    };
    ...
    const axisColor = this.isDarkMode ? '#ffffff' : '#333333';
    this.options1.series?.forEach(series => {
      if (series.type === 'area') {
        series.fill = this.isDarkMode ? '#C1EF00' : '#04B900';
      }
    });
  ...
  getData4() {
    return [
      { date: new Date(2023, 0, 1), revenue: 0, order: 536 },
      { date: new Date(2023, 1, 1), revenue: 535, order: 799 },
      { date: new Date(2023, 2, 1), revenue: 899, order: 783 },
      { date: new Date(2023, 3, 1), revenue: 907, order: 993 },
      { date: new Date(2023, 4, 1), revenue: 213, order: 536 },
      { date: new Date(2023, 5, 1), revenue: 422, order: 799 },
      { date: new Date(2023, 6, 1), revenue: 663, order: 783 },
      { date: new Date(2023, 7, 1), revenue: 752, order: 993 },
      { date: new Date(2023, 8, 1), revenue: 231, order: 536 },
      { date: new Date(2023, 9, 1), revenue: 123, order: 799 },
      { date: new Date(2023, 10, 1), revenue: 768, order: 783 },
      { date: new Date(2023, 11, 1), revenue: 982, order: 993 },
    ]
  }
  ...
  products: { image: string, title: string, type: string, percent: number }[] = [
    ...
    { image: 'assets/gloves.png', title: 'shoes', type: 'women', percent: 15 },
    { image: 'assets/shoes.png', title: 'shoes', type: 'women', percent: 25 },
    { image: 'assets/bag.png', title: 'shoes', type: 'women', percent: 30 },
